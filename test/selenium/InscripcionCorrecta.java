...
public class InscriptionCorrecta {
  ...
  @Test
  public void testInscriptionCorrecta() throws Exception {
    driver.get(baseUrl + "/DocsWeb/PlataformaTorneos2x2/src/torneos.html");
    // ERROR: Caught exception [unknown command [pause ]]
    ...
    driver.findElement(By.id("inputEmail")).sendKeys("Alumno@alu.ubu.es");
    ...
    assertTrue(isElementPresent(By.cssSelector("div.netlogo-model")));
  }
