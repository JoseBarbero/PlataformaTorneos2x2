...
public class LoginBadEmail {
  ...
  public void testLoginBadEmail() throws Exception {
    ...
    driver.findElement(By.id("email")).sendKeys("Alumno");
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("alumno");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertFalse(driver.findElement(By.linkText("Perfil")).isDisplayed());
