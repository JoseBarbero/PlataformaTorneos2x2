...
public class NuevoTorneoCorrecto {
  ...
  @Test
  public void testNuevoTorneoCorrecto() throws Exception {
    ...
    driver.findElement(By.id("punishment")).sendKeys("3");
    ...
    assertEquals("Torneo creado correctamente.", closeAlertAndGetItsText());
  }
